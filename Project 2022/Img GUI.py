...
button1=tk.Button(root,image=searchbtn,bd=0,bg="#cfd7ff",width=140,height=35,activebackground="#cfd7ff",highlightbackground="#cfd7ff",highlightcolor="#cfd7ff",command=verify)
